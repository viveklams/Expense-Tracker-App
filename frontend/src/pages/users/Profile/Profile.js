...
const Profile = () => {
  ...
  const incResult = profile?.income && calTransaction(profile?.income);

  //get expense statistics
  const expResult = profile?.expenses && calTransaction(profile?.expenses);

  console.log(incResult, expResult);
  const totalInc = profile?.income?.reduce((acc, curr) => {
